    ...
    <section className="history">
        <div className="history-container">
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-6 Pascal"> <img src={mysql} alt=""/></div>
                    <div className="col-md-6 Pascal-text">
                        <p className="p-4">
