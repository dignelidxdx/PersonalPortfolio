                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="socials">
                                                <ul>
                                                    <li><a href='https://www.facebook.com/digneli.davila/'><span className="ico-circle">
                                                        ...
                                                        <li><a href='https://www.instagram.com/dignelidxdx/'><span className="ico-circle">
                                                        ...
                                                        <li><a href='https://twitter.com/Digneli_Davila'><span className="ico-circle">
