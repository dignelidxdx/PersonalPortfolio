...
const Blog1 = () => (
    ...
    <section className="Blog1">
        <div>
            <section class="main">
                <h2 class="main__title">¿Qué quieres leer hoy?</h2>
        ...
        <div className="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Planificación para viajar fácil</h5>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">¿Cómo hago la maquetación?</h5>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Java, como mi lenguaje de programación</h5>
                            ...
                            <Link to="/java" class="btn btn-outline-primary">Leer Más</Link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">How (not) to learn english</h5>
                            <p class="card-text">Are very intelligent people better at learning languages that average people? No, experts have shown that intelligence doesn't make a lot of differente. What makes the biggest difference is your attitude.</p>
                            <Link to="/english" class="btn btn-outline-primary">Read More</Link>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
